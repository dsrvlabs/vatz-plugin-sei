...
func init() {
	...
	flag.Float64Var(&warnCondition, "warnCondition", defaultWarn, "Warning count")
	flag.Float64Var(&criticalCondition, "criticalCondition", defaultCritical, "Critical count")
